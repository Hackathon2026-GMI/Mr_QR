...
Serves controlled HTML pages for pipeline testing.
Run with: uvicorn tests.mock_server:app --port 9999
"""
...
async def fake_apk():
    return Response(
        ...
        headers={"Content-Disposition": "attachment; filename=fifa2026_security_update.apk"},
    )
